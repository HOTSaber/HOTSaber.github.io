...
```bash
docker run --name neo4j-Austin -p8502:7474 -p8503:7687  -d   -v $HOME/neo4j/data:/data   -v $HOME/neo4j/logs:/logs  -v $HOME/neo4j/import:/import  -v $HOME/neo4j/plugins:/plugins  --env NEO4J_AUTH=neo4j/88888888   neo4j:latest
```
