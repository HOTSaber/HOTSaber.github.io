...
## zotero addons （插件商店）
[zotero addons项目链接](https://github.com/syt2/zotero-addons)
这是一个用于在 [Zotero](https://www.zotero.org/) 内浏览、安装和评论插件的 [Zotero](https://www.zotero.org/) 插件
## Ethereal Style（zotero style）
[zotero style项目链接](https://github.com/MuiseDestiny/zotero-style)
zotero style如何配置请参考[# 如何在Zotero上与easyScholar联动](https://www.easyscholar.cc/blogs/10007)
## Green frog
[Green frog项目链接](https://github.com/redleafnew/zotero-updateifsE)
Green frog如何配置请参考[# 如何在Zotero上与easyScholar联动](https://www.easyscholar.cc/blogs/10007)
## Jasminum
