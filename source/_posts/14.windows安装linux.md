...
remote_port = 2222
```
再在云端服务器添加相应端口安全规则即可，详见[内网穿透](https://hotsaber.github.io/2023/10/10/13.%E5%86%85%E7%BD%91%E7%A9%BF%E9%80%8F/)
...
conda config --set auto_activate_base false #使用此命令控制base环境自启

You can undo this by running `conda init --reverse $SHELL`? [yes|no]
```
- 如无设置base环境自启动，可使用以下命令激活base环境
```
source activate
```
## 安装cuda
访问[cuda官网](https://developer.nvidia.com/cuda-toolkit-archive)，按服务器系统配置选择安装环境，按提示步骤安装即可
本教程使用以下安装代码：
```
...
**PS**:**pytorch**安装与离线安装请见[深度学习：本地环境部署](https://hotsaber.github.io/2023/09/28/%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0-1%20%E6%9C%AC%E5%9C%B0%E7%8E%AF%E5%A2%83%E9%83%A8%E7%BD%B2/)中的`安装Pytorch`-`本地安装`